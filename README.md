# srrc-capture-finger-prints

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/srrc-capture-finger-prints/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/srrc-capture-finger-prints)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/srrc-capture-finger-prints)
...
Our security policy is located [here](https://github.com/ministryofjustice/srrc-capture-finger-prints/security/policy).
...
`git remote add template https://github.com/ministryofjustice/srrc-capture-finger-prints`
